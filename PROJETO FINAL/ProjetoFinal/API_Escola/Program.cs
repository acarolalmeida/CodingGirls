...
builder.Services.AddDbContext<API_EscolaContext>(opt => opt.UseLazyLoadingProxies().UseSqlServer(builder.Configuration.GetConnectionString("ConnectionStringSQL")));
